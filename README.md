...
- **多提供商与模型管理** - 内置常用服务预设，也可连接自定义 OpenAI-compatible API；支持模型别名、能力参数和详情查看，模型卡片按供应商显示品牌图标。
- **Agent 应用配置** - 可视化管理 Codex CLI、Claude Code 与 OpenCode 的模型接入，支持模型映射、推理参数与功能开关，保存时写入各工具原生配置文件。
...
| 仪表盘 | 模型配置 | 应用设置 |
|---|---|---|
| <img src="./docs/screenshots/dashboard.png" alt="Melody Hub 仪表盘" width="280" /> | <img src="./docs/screenshots/models.png" alt="Melody Hub 模型配置（脱敏预览）" width="280" /> | <img src="./docs/screenshots/settings.png" alt="Melody Hub 应用设置" width="280" /> |
...
6. 如需为 Codex CLI、Claude Code 或 OpenCode 接入本地代理，在「Agent Apps」中选择应用并写入配置。
