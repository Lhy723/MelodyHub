...
float digit(vec2 p){
    ...
    if(uUseMouse > 0.5){
        vec2 mouseWorld = vec2(uMouse.x * aspect, uMouse.y) * uScale;
...
void main() {
    ...
    // Compensate for the container's aspect ratio so glyph cells stay
    // square instead of being stretched horizontally on wide cards.
