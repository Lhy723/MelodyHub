...
import { LayoutDashboard, Server, Cpu, Settings, AppWindow, History } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ activeKey, onNavigate }) => {
  ...
  const navItems: NavItem[] = [
    ...
    { key: 'requests', label: t('sidebar.requests'), icon: <History size={16} />, path: '/requests' },
